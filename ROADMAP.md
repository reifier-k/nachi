...
| マテリアル表現(dissolve/flow/fresnel = UEマテリアル相当) | M8 | ✅ 2026-07-11バッチ1-3(polar/Cartesian flow・dissolve・fresnel、CPU参照+RT byte照合) |
| VAT(頂点アニメーションテクスチャ)ランタイム | M8 | ✅ 2026-07-11バッチ3(Blender Extensions VAT 1行1frame互換、nearest/linear、float/remap、normal頂点stage) |
