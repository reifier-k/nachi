...
> [!WARNING]
> **HEAVY EXPERIMENTAL — v0.2.2 is not production-ready.** APIs, behavior, performance,
...
Nachi v0.2.2 is an experimental preview; M12 includes JSON assets, advanced simulation, React Three
